#ifndef LFO_SEQUENCER_H
#define LFO_SEQUENCER_H
...
void LFOSequencer::start() {
    ...
    wave2.frequencyIn_ptr = &noSignal;

    fltr.audioIn_ptr = &wave1.audioOut;
    fltr.cutoffIn_ptr = &fullSignal;
    fltr.cutoffModSourceIn_ptr = &wave2.audioOut;
